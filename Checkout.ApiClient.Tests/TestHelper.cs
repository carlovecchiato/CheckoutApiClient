...
namespace Tests
{
    public class TestHelper
    {
        ...
        public static Drink GetDrinkModel()
        {
            return new Drink()
            {
                Name = "water",
        ...
        public static Drink UpdateDrinkModel()
        {
            return new Drink()
            {
                Name = "pepsi",
        ...
        public static string ExistingDrinkName = "pepsi";
        public static int ExistingDrinkQuantity = 10;
        #endregion
